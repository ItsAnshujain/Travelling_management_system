...
<html lang="zxx">
<head>
    <title>Expedition Travel | Train Detail list</title>
   ...
   <div class="inner-banner">
     ...
     <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Train Detail list</li>
        </ol>
    </nav>
     
     <div class="modal-dialog" role="document">
            <center><h2 class="modal-title" id="exampleModalLabel1">Train Detail list</h2></center><br>
                            ...
                            <option class="text-center">Choose Ticket Class</option>
                             <%
                                ...
                                Connection myConnection=DriverManager.getConnection(PATH+PLACE, USERNAME, PASSWORD);
                                    try{
                                    PreparedStatement mystatement = myConnection.prepareStatement("select distinct(class) from traindetail");
